...
> In future versions, a new overload will be introduced.
> It will provide a way to refine the process of distinguishing the attributes, chosen for this specific purpose, from others with different functions or those generated by the compiler.
